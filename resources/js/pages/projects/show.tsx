...
export default function ProjectShow({ project, seo, relatedProjects, currency }: ProjectShowProps) {
    ...
    const ogImage = absoluteUrl(seo.og_image ? mediaUrl(seo.og_image) : project.hero_banner ? mediaUrl(project.hero_banner) : null);
    ...
    return (
        <PublicLayout>
            <Head>
                <title>{pageTitle(seo.title, name, project.title)}</title>
