    ...
    return (
        <section className="mx-auto w-full max-w-7xl px-4 pb-10 lg:px-8" aria-label="No projects">
            <div className="border-line flex min-h-[320px] flex-col items-center justify-center gap-4 border px-6 py-16 text-center">
                ...
                <h2 className="text-ink text-xl font-semibold max-sm:text-lg">No projects found</h2>
                ...
                {filtered && (
                    <Link
                        href="/projects"
                        className="bg-ink text-canvas mt-2 inline-flex items-center px-5 py-2.5 text-sm font-medium transition-opacity hover:opacity-90"
                    >
                        Reset filters
                    </Link>
                )}
